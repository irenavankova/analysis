...
# Sub ice shelf profile obsrvations
...
if 'PSsz' in globals():
    plt.plot(PSsz, PTcz, color='gray', linestyle='None', marker='.', markersize=nsize_obs)

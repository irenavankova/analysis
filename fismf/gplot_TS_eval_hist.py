...
tsegment = ["clim_2005-2014_ts_1951-2014"]
sims = ["hist"]
appe = ""
#tsapp = "_JAS"
tsapp = "_JFM"
...
for s in range(len(sims)):
    file_ts = f'/Users/irenavankova/Work/data_sim/E3SM_outputs/FISMF/ncfiles/{sims[s]}/{tsegment[s]}/TS{tsapp}.nc'
    dsOutc = xarray.open_dataset(file_ts)
    dsOutc = dsOutc[['timeMonthly_avg_activeTracers_temperature','timeMonthly_avg_activeTracers_salinity']]
    dsOutc.load()
...
dir_fig_save = '/Users/irenavankova/Work/data_sim/FISMF/TS_eval'
if opt_save == 1:
    plt.savefig(f'{dir_fig_save}/{region_name}{appe}{tsapp}.png', bbox_inches='tight', dpi=600)
else:
    plt.show()

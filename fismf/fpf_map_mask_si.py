...
iceshelves = ["si_ab", "si_rosse", "si_rossw", "si_ea", "si_amery", "si_dml", "si_weddell"]
...
colors = ["lightgray","yellowgreen","royalblue","gold","brown","lightskyblue","orange","darkorchid"]
...
if opt_save == 1:
    plt.savefig(f'/Users/irenavankova/Work/data_sim/FISMF/SeaIceTseries/SI_tseries_map.png', bbox_inches='tight', dpi=300)
else:
    plt.show()
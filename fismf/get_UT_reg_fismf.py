...
if ymem == 'ave':
    ds = xr.open_mfdataset(f"{fpath_fismf}v2_1.SORRM.ssp370-fismf_ensmean.mpaso.hist.am.timeSeriesStatsMonthly.*.nc", combine='by_coords', chunks={'time': 12}, parallel=True, decode_timedelta=True, preprocess=preprocess)
else:

...
# Load data
opt_save = 1
dir_fig_save = '/Users/irenavankova/Desktop/test'
...
year_init, year_end = 2, 3
month_init, month_end = 12, 13
...
if results_list_XY:
    ...
    combined_ds.to_netcdf(f'{dir_nc_save}/output_data_xy.{year:04d}-{month:02d}-01.nc')
...
if results_list_YZ:
    ...
    combined_ds.to_netcdf(f'{dir_nc_save}/input_data_yz.{year:04d}-{month:02d}-01.nc')

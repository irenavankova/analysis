...
colors = ["lightgray", "slategray", "cyan","green","yellowgreen","brown","lightcoral","darkorchid","plum"]
...
if opt_save == 1:
    plt.savefig(f'/Users/irenavankova/Work/data_sim/FISMF/TS_sim/TS_map.png', bbox_inches='tight', dpi=300)
else:
    plt.show()
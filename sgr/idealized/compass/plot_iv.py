...
class MoviePlotter(object):
    ...
    def plot_horiz_series_GL(self, da, nameInTitle, prefix, oceanDomain,
        ...
        if self.showProgress:
            bar.finish()
    def plot_horiz_series_plume_mask(self, da, nameInTitle, prefix, oceanDomain,
                          units=None, vmin=None, vmax=None, cmap=None,
                          cmap_set_under=None, cmap_set_over=None,
                          cmap_scale='linear', time_indices=None,
                          figsize=(3.5, 3)):
        ...
        for tIndex in time_indices:
            ...
            if units is None:
                ...
                title = '{} ({})'.format(nameInTitle, units)
            self._plot_horiz_field_plume_mask(field, title=title, outFileName=outFileName,
                                   oceanDomain=oceanDomain, vmin=vmin,
                                   vmax=vmax, cmap=cmap,
                                   cmap_set_under=cmap_set_under,
                                   cmap_set_over=cmap_set_over,
    ...
    def plot_vertical_section(self, da, nameInTitle, prefix, oceanDomain,
                          units=None, vmin=None, vmax=None, cmap=None,
                          cmap_set_under=None, cmap_set_over=None,
                          cmap_scale='linear', time_indices=None,
                          figsize=(7, 3)):
    ...
    def _plot_horiz_field_plume_mask(self, field, title, outFileName, oceanDomain=True,
                          vmin=None, vmax=None, figsize=(9, 3), cmap=None,
                          cmap_set_under=None, cmap_set_over=None,
                          cmap_scale='linear'):
        ...
        plt.xticks(fontsize=fnt)
        plt.yticks(fontsize=fnt)
        ax.set_xticks(numpy.linspace(455, 490, 2))
        ax.set_yticks(numpy.linspace(20, 60, 3))
        divider = make_axes_locatable(ax)

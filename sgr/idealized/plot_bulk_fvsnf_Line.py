...
if opt_save == 1:
    if lglg == 1:
        plt.savefig(f'{dir_fig_save}/plot_bulk_fvsnf_L_loglog.png', bbox_inches='tight', dpi=300)
    else:
        plt.savefig(f'{dir_fig_save}/plot_bulk_fvsnf_L.png', bbox_inches='tight', dpi=300)
else:
    plt.show()
